package com.xjc.code.oss.service;
 ...
 * @name PostObjectService*/


@Service
public class PostObjectService {
//    @Qualifier(value = "ossConfig")
    @Resource
...
/**
    ...
    public void PostObject() throws Exception {
        //配置文件
        // 上传文件
         String localFilePath = "D:\\data\\files\\headImage\\00e2063a-7ce2-4520-8bce-562e5bcf3be0.png";
    ...
    private static String formUpload(String urlStr, Map<String, String> formFields, String localFile)
        ...
        try {
            ...
            conn.setRequestProperty("Content-MD5", "md5-digest");
